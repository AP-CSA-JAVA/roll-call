...
2. On **Call on Someone**, choose a roster and a topic, then call. Open **Choose questions** to check or uncheck individual questions in that topic; only checked questions are asked.
